...
export const wsMessage = new WebSocketClass('ws://localhost:8181', someFn, 'wsName') // 这个链接一天只能发送消息50次
// export const wsMessage = new WebSocketClass('wss://echo.websocket.org', someFn, 'wsName') // 阮一峰老师教程链接
